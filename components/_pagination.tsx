...
const Index = ({pageCount, marginPagesDisplayed, pageRangeDisplayed}: Page) => {
  ...
  return (
    <>
      <nav className={"container flex flex-row justify-center items-center mx-auto my-6"} aria-label="Page navigation">
        <ReactPaginate
          ...
          nextLabel={'»'}
          breakLabel={"..."}
          breakClassName={"py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100"}
          className={"inline-flex -space-x-px"}
          pageClassName={"py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:underline"}
          // pageLinkClassName={""}
          activeClassName={"py-2 px-3 text-gray-500 bg-gray-200 cursor-not-allowed disabled:opacity-50"}
          ...
          hrefBuilder={(page, pageCount, selected) => {
            return (page >= 1 && page <= pageCount ? `${router.pathname}?page=${page}` : '#')
          }}
